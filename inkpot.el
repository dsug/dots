...
;; #1B1B33 #00ff8b #1B1B33 #2e2e2e #2e2e37 #2e2e3f
;; #303030 #306b8f #306d30 #3b205d #3e3e75 #404040
...
;; #b9b9b9 #c080d0 #cc6666 #cc66cc #cccc66 #00ff00
...
(custom-theme-set-faces
 'inkpot
 '(default ((t (:background "#1B1B33" :foreground "#cfbfad"))))
 ...
 '(linum ((t (:background "#3e3e75" :foreground "#8b8bcd"))))
 ...
 '(mode-line ((t (:bold t :foreground "#b9b9b9" :background "#3e3e75"))))
 '(mode-line-inactive ((t (:bold t :foreground "#708090" :background "#3e3e75"))))
 '(mode-line-buffer-id ((t (:bold t :foreground "#b9b9b9" :background "#3e3e75"))))
 ...
 '(message-cited-text ((t (:foreground "#00ff00"))))
 ...
 '(gnus-group-mail-3-face ((t (:bold t :foreground "#00ff00"))))
 '(gnus-group-mail-3 ((t (:bold t :foreground "#00ff00"))))
 ...
 '(gnus-group-news-3-face ((t (:bold t :foreground "#00ff00"))))
 ...
 '(gnus-header-from ((t (:bold t :foreground "#00ff00"))))
 ...
 '(gnus-summary-cancelled-face ((t (:foreground "#00ff00"))))
 '(gnus-summary-cancelled ((t (:foreground "#00ff00"))))
 ...
 '(message-header-to ((t (:foreground "#00ff00"))))
 '(message-header-cc ((t (:foreground "#409090"))))
 '(font-latex-bold-face ((t (:foreground "#00ff00"))))
 ...
 '(org-agenda-date-today ((t (:weight bold :foreground "#00ff00"))))
 ...
 '(company-scrollbar-fg ((t (:background "#1B1B33"))))

 ;; helm (melpa)
 '(helm-selection ((t (:background "#2e2e37"))))

 ;; neotree
 '(neo-banner-face ((t (:foreground "#00ff00"))))
 '(neo-header-face ((t (:foreground "#00ff00"))))
